            ...
            {products.map((product) => (
              <div key={product._id} className="group cursor-pointer bg-white rounded-2xl border border-gray-100 hover:border-red-500/30 overflow-hidden hover:shadow-[0_20px_50px_rgba(220,38,38,0.1)] transition-all duration-700 animate-fade-in-up">
                ...
                <div className="px-6 pb-6">
                  <button className="w-full bg-black hover:bg-red-600 text-white py-4 rounded-xl text-xs font-black uppercase tracking-widest transition-all duration-500 flex items-center justify-center gap-3 shadow-sm hover:shadow-xl active:scale-95 group/btn opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0">

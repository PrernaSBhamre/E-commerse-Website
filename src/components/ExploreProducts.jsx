        ...
        {products && products.length > 0 ? (
          products.slice(0, 4).map((product) => (
            <div key={product._id} className="group cursor-pointer bg-white rounded-xl border border-gray-100 hover:border-red-500/30 overflow-hidden hover:shadow-[0_8px_30px_rgba(220,38,38,0.15)] transition-all duration-500">
              ...
              {/* Add To Cart */}
              <div className="p-4 bg-red-50/30 border-t border-gray-100">
                 <button className="w-full bg-black hover:bg-red-600 text-white py-3 text-xs font-bold uppercase tracking-wider transform translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-2">
